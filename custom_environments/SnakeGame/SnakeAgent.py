...
if __name__ == "__main__":
    ...
    data = pd.DataFrame(
        {'Episode No': results[agent_list[0]][0][0], 'Score': results[agent_list[0]][0][1], 'Steps': results[agent_list[0]][0][3],
         'Rolling Score': results[agent_list[0]][0][2]})
    data.to_csv('output_DDQN_200episodes_1.csv', encoding='utf-8-sig')
    print('end')
